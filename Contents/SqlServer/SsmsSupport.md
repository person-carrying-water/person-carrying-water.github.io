...
[SQL Server Management Studio19リリースノート(us)](https://docs.microsoft.com/en-us/sql/ssms/release-notes-ssms-19?view=sql-server-ver15)  
**ライフサイクルポリシー： モダンサイクル**  
[モダンライフサイクル ポリシー](https://docs.microsoft.com/ja-JP/lifecycle/policies/modern)  

| リリース番号   |  ビルド番号    | リリース日  | サポート期限 |  状態   |
| :------------ | :------------ | ---------: | ----------: | :-----: |
| 19.0.1        | 19.0.20200.0  | 2023/02/02 | 次のリリース | 現在 |
