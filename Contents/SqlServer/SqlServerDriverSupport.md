...
| 7.4.0    | Microsoft JDBC Driver 7.4 for SQL Server  | Stable        | 2019/07/31 |           2024/07/31 | JRE12、JRE11、JRE8    |  valid  |
...
| :------ | :----------------------------------- | :--------- | ---------: | -------------------: | :------------------------------ | :-----: |
| 5.12.0-beta1 | SQL Server 用 Microsoft PHP ドライバー 5.12| Production | 2023/12/09 |           2028/02/28 | 8.3.0+<br />8.2.0+<br />8.1.0+<br />8.0.0+  | ベータ |
| 5.11.1  | SQL Server 用 Microsoft PHP ドライバー 5.11| Production | 2023/09/06 |           2028/02/28 | 8.2.0+<br />8.1.0+<br />8.0.0+  |   現在  |
| 5.11.0  | SQL Server 用 Microsoft PHP ドライバー 5.11| Production | 2023/03/07 |           2028/02/28 | 8.2.0+<br />8.1.0+<br />8.0.0+  |   現在  |
...
| 5.6.0   | SQL Server 用 Microsoft PHP ドライバー 5.6 | Production | 2019/02/21 |           2024/02/21 | 7.3.0+<br />7.2+<br />7.1.0+    |  valid  |
