...
| :----------------- | -------------: | ---------: |:------------:| ---------: | ---------: | ---------: | ---------: | :-----: |
|すべてのエディション| 16.0.1000.6　　  | 2022/11/16 | 固定サイクル | 2022/11/16 | 2023/04/13 | 2028/01/11 | 2033/01/11 | 現在 |
...
| :-----------: | :---------- | ---------: | :-------: | :----------: | :-----: |
| CU3           | 16.0.4025.1 | 2023/04/13 | KB5024396 | 累積更新プログラム |  現在  |
| CU2           | 16.0.4015.1 | 2023/03/16 | KB5023127 | 累積更新プログラム |  有効  |
| CU1           | 16.0.4003.1 | 2023/02/16 | KB5022375 | 累積更新プログラム |  有効  |
| GDR           | 16.0.1050.5 | 2023/02/14 | KB5021522 | 重大更新プログラム |  現在  |
...
| エディション       | 初回ビルド番号 | リリース日 | ﾗｲﾌｻｲｸﾙﾎﾟﾘｼｰ | ﾗｲﾌｻｲｸﾙ<br />の開始日 | 最新更新日 | ﾒｲﾝｽﾄﾘｰﾑ<br />ｻﾎﾟｰﾄ期限 | 延長<br>ｻﾎﾟｰﾄ期限 | 状態 |
| :----------------- | -------------: | ---------: |:------------:| ---------: | ---------: | ---------: | ---------: | :-----: |
|すべてのエディション| 15.0.2000.5    | 2019/11/04 | 固定サイクル | 2019/11/04 | 2023/04/13 | 2025/01/07 | 2030/01/08 |  現在  |
...
| エディション       | 初回ビルド番号 | リリース日 | ﾗｲﾌｻｲｸﾙﾎﾟﾘｼｰ | ﾗｲﾌｻｲｸﾙ<br />の開始日 | 最新更新日 | ﾒｲﾝｽﾄﾘｰﾑ<br />ｻﾎﾟｰﾄ期限 | 延長<br>ｻﾎﾟｰﾄ期限 | 状態 |
| :----------------- | ------------: | ---------: |:------------:| ---------: | ---------: | ---------: | ---------: | :-----: |
|すべてのエディション| 14.0.1000.169  | 2017/10/02 | 固定サイクル | 2017/09/29 | 2023/02/14 | 2022/10/11 | 2027/10/12 | current |
...
|更新プログラム名 |  ビルド番号  | 更新発表日 | ﾅﾚｯｼﾞﾍﾞｰｽ | 提供プログラム名 |   状態   |
| :------------: | :----------- | ---------: | :-------: | :-------------: | :------: |
| CU31 GDR       | 14.0.3460.9  | 2023/02/14 | KB5021126 |重大累積プログラム| 現在 |
| GDR            | 14.0.2047.8  | 2023/02/14 | KB5021127 |重大更新プログラム| 現在 |
...
| エディション       | 初回ビルド番号 | リリース日 | ﾗｲﾌｻｲｸﾙﾎﾟﾘｼｰ | ﾗｲﾌｻｲｸﾙ<br />の開始日 | 最新更新日 | ﾒｲﾝｽﾄﾘｰﾑ<br />ｻﾎﾟｰﾄ期限 | 延長<br>ｻﾎﾟｰﾄ期限 | 状態 |
| :----------------- | -------------: | ---------: |:------------:| ---------: | ---------: | ---------: | ---------: | :-----: |
| Service Pack3      | 13.0.6419.1    | 2021/09/15 | 固定サイクル | 2021/09/15 | 2023/02/14 | 2021/07/13 | 2026/07/14 | 現在 |
...
|更新プログラム名|  ビルド番号  | 更新発表日 | ﾅﾚｯｼﾞﾍﾞｰｽ | 提供プログラム名 |  状態   |
| :------------: | :----------- | ---------: | :-------: | :--------------: | :-----: |
| SP3 GDR        | 13.0.6430.49 | 2023/02/14 | KB5021129 |重大更新プログラム|  現在  |
| SP3 GDR        | 13.0.6419.1  | 2022/06/14 | KB4052908 |重大更新プログラム|  現在  |
...
| エディション       | 初回ビルド番号 | リリース日 | ﾗｲﾌｻｲｸﾙﾎﾟﾘｼｰ | ﾗｲﾌｻｲｸﾙ<br />の開始日 | 最新更新日 | ﾒｲﾝｽﾄﾘｰﾑ<br />ｻﾎﾟｰﾄ期限 | 延長<br>ｻﾎﾟｰﾄ期限 | 状態 |
| :----------------- | -------------: | ---------: |:------------:| ---------: | ---------: | ---------: | ---------: | :-----: |
| Service Pack3      | 12.0.6024.0    | 2018/10/30 | 固定サイクル | 2018/10/30 | 2023/02/14 | 2019/07/09 | 2024/07/09 | 現在 |
...
|更新プログラム名|  ビルド番号  | 更新発表日 | ﾅﾚｯｼﾞﾍﾞｰｽ | 提供プログラム名 |  状態   |
| :------------: | :----------- | ---------: | :-------: | :--------------: | :-----: |
| SP3 CU4 + GDR  | 12.0.6444.4  | 2023/02/14 | KB5021045 |累積セキュリティ更新| 現在 |
| SP3 GDR        | 12.0.6174.8  | 2023/02/14 | KB5021037 |重大更新プログラム| 現在 |
| SP3 CU4 + GDR  | 12.0.6439.10 | 2022/06/14 | KB5014164 |累積セキュリティ更新| 現在 |
| SP3 GDR        | 12.0.6169.19 | 2022/06/14 | KB5014165 |重大更新プログラム| 現在 |
...
| エディション       | 初回ビルド番号 | リリース日 | ﾗｲﾌｻｲｸﾙﾎﾟﾘｼｰ | ﾗｲﾌｻｲｸﾙ<br />の開始日 | 最新更新日 | ﾒｲﾝｽﾄﾘｰﾑ<br />ｻﾎﾟｰﾄ期限 | 延長<br>ｻﾎﾟｰﾄ期限 | 状態 |
| :----------------- | -------------: | ---------: |:------------:| ---------: | ---------: | ---------: | ---------: | :-----: |
| Extended Security Update Year 3 | 11.0.xxxx.0    | 2024/07/09 | 固定サイクル | 2024/07/09 | xxxx/xx/xx | 2025/07/08 | 2025/07/08 | 将来  |
| Extended Security Update Year 2 | 11.0.xxxx.0    | 2023/07/11 | 固定サイクル | 2023/07/11 | xxxx/xx/xx | 2024/07/09 | 2024/07/09 | 次期 |
| Extended Security Update Year 1 | 11.0.xxxx.0    | 2022/07/12 | 固定サイクル | 2022/07/12 | 2023/02/14 | 2023/07/11 | 2023/07/11 | 現在 |
...
| エディション       | 初回ビルド番号 | リリース日 | ﾗｲﾌｻｲｸﾙﾎﾟﾘｼｰ | ﾗｲﾌｻｲｸﾙ<br />の開始日 | 最新更新日 | ﾒｲﾝｽﾄﾘｰﾑ<br />ｻﾎﾟｰﾄ期限 | 延長<br>ｻﾎﾟｰﾄ期限 | 状態 |
| :----------------- | -------------: | ---------: |:------------:| ---------: | ---------: | ---------: | ---------: | :-----: |
| Extended Security Update Year 4(Azure only) | 10.50.xxxx.0   | 2022/07/13 | 固定サイクル | 2022/07/13 | 2023/02/14 | 2023/07/11 | 2023/07/11 | 現在 |
...
| エディション       | 初回ビルド番号 | リリース日 | ﾗｲﾌｻｲｸﾙﾎﾟﾘｼｰ | ﾗｲﾌｻｲｸﾙ<br />の開始日 | 最新更新日 | ﾒｲﾝｽﾄﾘｰﾑ<br />ｻﾎﾟｰﾄ期限 | 延長<br>ｻﾎﾟｰﾄ期限 | 状態 |
| :----------------- | -------------: | ---------: |:------------:| ---------: | ---------: | ---------: | ---------: | :-----: |
| Extended Security Update Year 4(Azure only) | 10.00.xxxx.0   | 2022/07/13 | 固定サイクル | 2022/07/13 | 2023/02/14 | 2023/07/11 | 2023/07/11 | 現在 |
